...
import { troubleShooting6columns } from "../utility/troubleShootingColumnsData";
import Spinner from "../shared/Spinner";

export const Troubleshooting6 = () => {
  useEffect(() => {
    getData();
  }, []);
  ...
  const setDataToTables = (res1) => {
    ...
    if (
      ...
      troubleShooting6columns.forEach((col) => {
        myColumns.push({
          name: col,
  ...
  return (
    <>
      <div>
        <h2>Troubleshooting Call Search (View 6)</h2>
      ...
      {/* <div>
        <h2 className="py-2">Troubleshooting Call Search (View 6)</h2>
        <div className="row">
...
export default Troubleshooting6;
