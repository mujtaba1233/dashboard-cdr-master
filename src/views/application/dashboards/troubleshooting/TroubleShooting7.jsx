...
import { troubleShooting7columns } from "../utility/troubleShootingColumnsData";
import Spinner from "../shared/Spinner";

export const Troubleshooting7 = () => {
  useEffect(() => {
    getData();
  }, []);
  ...
  const setDataToTables = (res1) => {
    ...
    if (
      ...
      troubleShooting7columns.forEach((col) => {
        myColumns.push({
          name: col,
  ...
  return (
    <>
      ...
      <div>
        <h2>Troubleshooting Call Search (View 7)</h2>
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} sm={6}>
            ...
            <div>
              <Button onClick={applyChanges1} variant="contained" color="primary">
                Apply Changes
              </Button>
              <Button onClick={clearForm1} variant="contained" color="default">
                Clear form
              </Button>
            </div>
          </Grid>
          <Grid item xs={12} sm={6}>
            ...
            <div>
              <Button onClick={applyChanges2} variant="contained" color="primary">
                Apply Changes
              </Button>
              <Button onClick={clearForm2} variant="contained" color="default">
                Clear form
              </Button>
            </div>
          </Grid>
      ...
      <div>
        <h2 className="py-2">Troubleshooting Call Search (View 7)</h2>
        <div className="row">
...
export default Troubleshooting7;
