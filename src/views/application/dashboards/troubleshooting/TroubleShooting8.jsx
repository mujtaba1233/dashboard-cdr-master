...
import { troubleShooting8columns } from "../utility/troubleShootingColumnsData";
import Spinner from "../shared/Spinner";

export const Troubleshooting8 = () => {
  useEffect(() => {
    getData();
  }, []);
  ...
  const setDataToTables = (res1) => {
    ...
    if (
      ...
      troubleShooting8columns.forEach((col) => {
        myColumns.push({
          name: col,
  ...
  return (
    <>
      <div>
        <h2>Troubleshooting Call Search (View 8)</h2>
      ...
      {/* <div>
        <h2 className="py-2">Troubleshooting Call Search (View 8)</h2>
        <div className="row">
...
export default Troubleshooting8;
