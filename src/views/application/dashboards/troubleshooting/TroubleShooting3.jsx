...
import { troubleShooting3columns } from "../utility/troubleShootingColumnsData";
import Spinner from "../shared/Spinner";

export const Troubleshooting3 = () => {
  ...
  const setDataToTables = (res1) => {
    ...
    if (
      ...
      troubleShooting3columns.forEach((col) => {
        myColumns.push({
          name: col,
  ...
  return (
    <>
      <div>
        <h2>Troubleshooting Call Search (View 3)</h2>
      ...
      {/* <div>
        <h2 className="py-2">Troubleshooting Call Search (View 3)</h2>
        <div className="row">
...
export default Troubleshooting3;
