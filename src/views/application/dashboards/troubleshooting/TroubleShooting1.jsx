...
import { troubleShooting1columns } from "../utility/troubleShootingColumnsData";
import Spinner from "../shared/Spinner";

export const Troubleshooting1 = () => {
  useEffect(() => {
    getData();
  }, []);
  ...
  const setDataToTables = (res1) => {
    ...
    if (
      ...
      troubleShooting1columns.forEach((col) => {
        myColumns.push({
          name: col,
  ...
  return (
    <>
      <div>
        <h2>Troubleshooting Call Search (View 1)</h2>
        ...
        <div>
          <h2>Advanced Call Search 1</h2>
          {/* DataTable component here */}
          <DataTable
            title="Advanced Call Search 1"
            columns={columns}
            data={data}
            theme="solarized"
      ...
      {/* <div>
        <h2 className="py-2">Troubleshooting Call Search (View 1)</h2>
        <div className="row">
...
export default Troubleshooting1;
